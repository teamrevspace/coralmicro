...
class PoseCanvas(tk.Frame):
    ...
    def update_poses(self, poses, r=5, threshold=0.2):
        ...
        for pose in poses:
            pose_keypoints = pose.keypoints.keys()
            if KeypointType.NOSE in pose_keypoints and KeypointType.LEFT_EYE in pose_keypoints \
                and KeypointType.RIGHT_EYE in pose_keypoints and KeypointType.LEFT_EAR in pose_keypoints \
                    and KeypointType.RIGHT_EAR in pose_keypoints:
